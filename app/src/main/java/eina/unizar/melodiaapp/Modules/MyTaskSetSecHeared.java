...
public class MyTaskSetSecHeared extends AsyncTask<String, Void, String> {
    ...
    public String doInBackground(String... params) {
        ...
        String numSec = params[3];
        String result = "";

        try { //SetSongLista(String idUsr, String contrasenya, String idLista, String idAudio): int
            MySingleton singleton = MySingleton.getInstance();
            URL url = new URL("http://" + singleton.getMyGlobalVariable() + ":8081/AddSecondsToSong/");
            ...
            String jsonInputString = "{\"idUsr\": \"" + idUsuario + "\", \"contrasenya\": \"" + contrasenya + "\", \"second\": \"" + numSec + "\" , \"idAudio\": \"" + idAudio + "\"}";
