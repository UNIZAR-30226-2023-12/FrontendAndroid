...
/**
 * Clase que implementa una petición POST para obtener la valoración de un audio.
 */
public class MyTaskGetRating extends AsyncTask<String, Void, String> {

    /**
     * Método que se ejecuta en segundo plano para realizar la petición al servidor y
     * obtener la valoración de un audio.
     * @param params idUsuario, contrasenya, idAudio
     * @return Devuelve un código de respuesta HTTP proporcionado por el servidor y la valoración del audio.
     */
    @Override
